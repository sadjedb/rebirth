...
export default function ProductInventoryError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[admin/inventory/productId]", error);
  }, [error]);

  return (
    <div className="p-6 max-w-[1400px] mx-auto">
      <div className="rounded-lg border border-admin-border bg-admin-surface p-8 text-center">
        <p className="text-sm font-medium text-admin-fg mb-2">Couldn&apos;t load this product&apos;s inventory.</p>
